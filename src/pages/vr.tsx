...
import nightfallspicnic from '../media/recroom/nightfallspicnic.jpg';
...
export const VR = () => {
    ...
    return (
        <Container className="marketing">
            ...
            <Creation title="Gate To Atlantis" image={atlantissideviewq} description="Gate to Atlantis is a fictional remake of the iconic Lost City of Atlantis. How Atlantis actually looks is a mystery, so I predicted how it looks like." link="/vr/atlantis" />
            <Creation title="Night Falls" image={nightfallspicnic} description="Night Falls is my latest creation. It is a comfortable picnic at a view looking upon a range of beautiful mountains. Fun Fact! I wrote this before the room was released." link="" />
